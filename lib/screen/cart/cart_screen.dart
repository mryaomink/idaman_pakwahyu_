        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) => Padding(
            ...
            child: Dismissible(
              ...
              child: CartCard(cart: keranjang[index]),
            ),
          ),
        ),
      ),
        ...
        for(var i = 0; i < it.data.length; i++) {
          ...
          carts.add(
              new Cart(
                  ...
                  tarif_per_km: it.data[i]['tarif_per_km'],
                  avg_jarak: it.data[i]['avg_jarak'],
                  biaya_kurir: it.data[i]['biaya_kurir'],
                  error: it.data[i]['error'],
                  product: new Product(
                    ...
                    satuan_berat_id: it.data[i]['produk']["satuan_berat_id"],
