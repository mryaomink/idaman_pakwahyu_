          ...
          body: TabBarView(
            children: [
              ...
              if(widget.usaha.nama_usaha.isNotEmpty)
                Browser(searchString: "umkm_usaha_id=${widget.usaha.id}&reorder=jarak&user_lat="+lm.latitude+"&user_lon="+lm.longitude, keyword: widget.usaha.nama_usaha, umkm_usaha_id: widget.usaha.id, owned: widget.usaha.nik==MyApp.localStorage.get("nik").toString() ? true : false),
